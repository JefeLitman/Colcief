                                    ...
                                    <div class="row">
                                        @foreach ($curso[0] as $c)
                                            <div class="col-12 col-sm-4 col-lg-2">
                                                <a class="form-control btn btn-primary mt-3" href="/horarios/{{$c->pk_curso}}/crear" role="button">{{$c->prefijo}}-{{$c->sufijo}}</a>
                                            </div>
                                        @endforeach 
                                    </div>
                                @endif
                                ...
                                @else
                                    <div class="row">
                                        @foreach ($curso[2] as $c)
                                            <div class="col-12 col-sm-4 col-lg-2">
                                                <a class="form-control btn btn-primary mt-3" prefijo="{{$c->prefijo}}" sufijo="{{$c->sufijo}}" href="/horarios/{{$c->pk_curso}}/crear" role="button">{{$c->prefijo}}-{{$c->sufijo}}</a>
                                            </div>
                                        @endforeach
                                    </div>
                                @endisset
